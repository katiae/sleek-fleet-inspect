...
import { CheckSquare, FileText, Users, Calendar, Clock, MessageSquare, Send, Sparkles, AlertCircle, TrendingUp, Activity, CirclePlay, CircleDot, LayoutGrid } from "lucide-react";
...
const Dashboard = () => {
  ...
  return <SidebarProvider>
      <div className="min-h-screen flex w-full relative">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-orange-200/60 via-pink-200/50 to-purple-200/40 rounded-full blur-2xl pointer-events-none z-0"></div>
